...
@WebServlet("/user2")
public class UserSevlet2 extends HttpServlet {

    public void init(ServletConfig config) throws ServletException {
        List<User> usersList = new ArrayList<>();
                usersList.add(new User(0,"aaa", "1111", "aaaaaa", "aaa@gmail.com"));
                usersList.add(new User(0,"bbb", "1111", "bbbbbb", "bbb@gmail.com"));
                usersList.add(new User(0,"ccc", "1111", "cccccc", "ccc@gmail.com"));
                usersList.add(new User(0,"ddd", "1111", "dddddd", "ddd@gmail.com"));
                usersList.add(new User(0,"eee", "1111", "eeeeee", "eee@gmail.com"));
