...
function AccountPage(props) {
    ...
    const updataProfileImgMutation = useUpdateProfileImgMutation();
    ...
    const handleProfileImgFileOnChange = async (e) => {
        ...
        await updataProfileImgMutation.mutateAsync(formData);
        loginUser.refetch();
    }
        ...
        <div css={s.container}>
            ...
            <div css={s.accountBox}>
                ...
                <div>
                    ...
                    <button css={s.saveButton} onClick={handleSaveNicknameButtonOnClick} disabled={loginUser?.data?.data.nickname === nicknameValue} >save</button>
                </div>
            </div>
            ...
            <div>
                <div css={s.itemGroup}>
                    ...
                    <button css={s.borderButton} onClick={() => api.post("/api/auth/email", {email: "chlaudwns94@naver.com"})}>Change email</button>
                </div>
                <div css={s.itemGroup}>
                    <div>
